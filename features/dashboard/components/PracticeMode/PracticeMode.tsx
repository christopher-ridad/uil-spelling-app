...
export default function PracticeMode({ fromColor, toColor, buttonText, subText, href }: FeatureButtonProps) {
    return (
        <Link href={href}>
            <button className={`flex flex-col items-start bg-gradient-to-br ${fromColor} ${toColor} rounded-xl p-6 w-full hover:shadow-2xl cursor-pointer transition-all hover:scale-105 active:scale-95 group`}>
                <BookOpenIcon />
